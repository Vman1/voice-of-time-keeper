  ...
  return (
    <div className="w-full max-w-4xl mx-auto glass-card rounded-lg animate-fade-in">
      <Tabs defaultValue="alarm" className="w-full">
        <TabsList className="grid w-full grid-cols-3 p-1 bg-secondary/20 backdrop-blur-sm rounded-t-lg">
          ...
          <TabsTrigger value="stopwatch" className="data-[state=active]:bg-primary/10 data-[state=active]:text-primary transition-all">Stop Watch</TabsTrigger>
        ...
        <TabsContent value="stopwatch" className="animate-scale-in">
          <StopWatch />
        </TabsContent>
