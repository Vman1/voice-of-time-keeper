  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium text-foreground", // Added text-foreground
        ...
        head_row: "flex",
        head_cell:
          "text-foreground rounded-md w-9 font-normal text-sm", // Increased font size and added text-foreground
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-normal text-foreground aria-selected:opacity-100" // Added text-foreground
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-accent text-accent-foreground font-medium", // Added font-medium
        day_outside:
